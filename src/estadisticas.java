...
public void paint (Graphics g){
    super.paint (g);
    if(bandera==true){
        String String_correctas = txt_correctas.getText();
        String String_incorrectas = txt_incorrectas.getText();
        
        int int_correctas=Integer.parseInt(String_correctas);
        int int_incorrectas=Integer.parseInt(String_incorrectas);
        System.out.println(int_correctas+"hola");
         System.out.println(int_incorrectas+"hola");
        ...
        int valor_mayor= mayorvalor(int_correctas,int_incorrectas);
        
        int largo_correctas=int_correctas*400/valor_mayor;
        int largo_incorrectas=int_incorrectas*400/valor_mayor;
        
        g.setColor(new Color(255,0,0));
        g.fillRect(100,100,largo_correctas,40);
        g.drawString("correctas",10,125);
        ...
        if (porcentaje >=30 && porcentaje<=40.0){
